$(function() {
    ...
    $("#informasi-form").ajaxForm({
        dataType: "json",
        url: base_url + 'informasi/save',
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.type != 'done') {
                    ...
                    $('#informasi_text').val(data.msg[0].informasi_text);
                    $('#informasi_content').val(data.msg[0].informasi_content);
                    $('input[name=is_active][value='+data.msg[0].is_active+']').prop('checked', true);
